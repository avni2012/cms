                ...
                <div class="bg-gray-50 px-4 py-2 sm:px-6 sm:flex sm:flex-row-reverse">
                    <span>
                        <button wire:click.prevent="update()" type="button"
                            class="rounded-md border border-transparent px-4 py-2 bg-success text-base leading-6 font-bold text-white shadow-sm">
                            Update
                        </button>
                    </span>
                    <span class="ml-2">
                        <button wire:click="closeEditPageModal()" type="button"
                            class="rounded-md border border-gray-300 px-4 py-2 bg-secondary text-base leading-6 font-bold text-white shadow-sm">
                            Cancel
                        </button>
                    </span>
                </div>
