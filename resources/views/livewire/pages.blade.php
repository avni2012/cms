<div>
    ...
    <div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        	<button wire:click="create()" class="my-4 inline-flex justify-center rounded-md border border-transparent px-4 py-2 bg-success text-base font-bold text-white shadow-sm hover:bg-red-700">Create Page</button>
